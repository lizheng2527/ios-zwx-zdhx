...
- (void)addCustomNotification:(id)sender{
    ...
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:NSLocalizedString(@"APP_YUNXIN_Contact_chooseType", nil) delegate:nil cancelButtonTitle:NSLocalizedString(@"APP_General_Cancel", nil) destructiveButtonTitle:nil otherButtonTitles:@"单聊",@"群组", nil];
...
- (void)didFinishedSelect:(NSArray *)selectedContacts{
    ...
    [[vc addAction:NSLocalizedString(@"APP_General_Confirm", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
    ...
    addAction:NSLocalizedString(@"APP_General_Cancel", nil) style:UIAlertActionStyleCancel handler:nil];
