...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = NSLocalizedString(@"APP_YUNXIN_chatRecord", nil);
    [self prepareMember];
...
- (NSArray *)fetchData:(UITableView *)tableView{
    if (tableView == self.tableView) {
        ...
        obj.content  = self.keyWord.length? [NSString stringWithFormat:@"%@：“%@”",NSLocalizedString(@"APP_wareHouse_search", nil),self.keyWord] : @"";
