...
- (CGRect)scanRect
{
    if (CGRectEqualToRect(_scanRect, CGRectZero)) {
        ...
        _scanRect = CGRectMake(rectOfInterest.origin.y * SCREENWIDTH, rectOfInterest.origin.x * SCREENHEIGHT - 68, xOffset * SCREENWIDTH, yOffset * SCREENHEIGHT );
    }
    return _scanRect;
}
