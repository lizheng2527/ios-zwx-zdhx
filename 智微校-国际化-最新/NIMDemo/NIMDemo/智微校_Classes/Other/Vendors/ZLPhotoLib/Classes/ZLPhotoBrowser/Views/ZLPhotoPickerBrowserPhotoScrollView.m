...
- (void)longGesture:(UILongPressGestureRecognizer *)gesture{
    if (gesture.state == UIGestureRecognizerStateBegan) {
        ...
        if (!self.sheet) {
            self.sheet = [[UIActionSheet alloc] initWithTitle:NSLocalizedString(@"APP_General_Prompt", nil) delegate:self cancelButtonTitle:NSLocalizedString(@"APP_General_Cancel", nil) destructiveButtonTitle:@"保存到相册" otherButtonTitles:nil, nil];
        }
