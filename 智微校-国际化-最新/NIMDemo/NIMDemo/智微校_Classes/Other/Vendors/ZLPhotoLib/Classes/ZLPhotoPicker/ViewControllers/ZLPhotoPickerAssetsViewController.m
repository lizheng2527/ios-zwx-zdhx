...
- (UICollectionView *)toolBarThumbCollectionView{
    if (!_toolBarThumbCollectionView) {
        ...
        UICollectionView *toolBarThumbCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(10, 0, self.view.zl_width - 20, 44) collectionViewLayout:flowLayout];
...
- (void) setupButtons{
    ...
    UIBarButtonItem * barButtonItem = [[UIBarButtonItem alloc] initWithCustomView:self.doneBtn];
    
    self.navigationItem.rightBarButtonItem = barButtonItem;
    //[[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStyleDone target:self action:@selector(back)];
}
