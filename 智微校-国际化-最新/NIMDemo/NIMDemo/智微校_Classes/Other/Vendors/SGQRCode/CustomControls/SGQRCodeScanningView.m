...
//    promptLabel.text = @"将二维码/条码放入框内, 即可自动扫描";
    promptLabel.text = NSLocalizedString(@"APP_General_scanCodeToLogin", nil);
    ...
    [light_button setTitle:NSLocalizedString(@"APP_General_OpenLigght", nil) forState:UIControlStateNormal];
    [light_button setTitle:NSLocalizedString(@"APP_General_closeLigght", nil) forState:UIControlStateSelected];
