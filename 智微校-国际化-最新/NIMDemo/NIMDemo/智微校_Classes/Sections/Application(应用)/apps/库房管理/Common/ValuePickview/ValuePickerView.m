...
- (void)initSubViews
{
    ...
    [self.finishBtn setTitle:NSLocalizedString(@"APP_General_Confirm", nil) forState:UIControlStateNormal];
    ...
    [self.cancelBtn setTitle:NSLocalizedString(@"APP_General_Cancel", nil) forState:UIControlStateNormal];
...
- (void)layoutSelfSubviews
{
    ...
    //标题
    self.titleLabel.frame = CGRectMake(70, 7.5, SCREEN_WIDTH - 140, 30);[self.cancelBtn sizeToFit];
