...
//    dateCancleButton.backgroundColor = UIColorFromRGB(0xff4c4c4c);
    ...
    [dateCancleButton setTitle:NSLocalizedString(@"APP_General_Cancel", nil) forState:UIControlStateNormal];
    [dateCancleButton sizeToFit];
...
//        [dateCancleButton setImageEdgeInsets:UIEdgeInsetsMake(12, 12, 12,12)];
    ...
    [dateConfirmButton setTitle:NSLocalizedString(@"APP_General_Confirm", nil) forState:UIControlStateNormal];
    [dateConfirmButton sizeToFit];
...
//    dateConfirmButton.backgroundColor = UIColorFromRGB(0xff4c4c4c);
    ...
    if ([title isEqualToString:@"请选择日期"]) {
        dateCancleButton.backgroundColor = [UIColor colorWithRed:95/255.0 green:206/255.0 blue:156/255.0 alpha:1];
        dateConfirmButton.backgroundColor = [UIColor colorWithRed:95/255.0 green:206/255.0 blue:156/255.0 alpha:1];
    }
