...
+ (instancetype)defaultConfiguration {
    return [CWLateralSlideConfiguration configurationWithDistance:kCWSCREENWIDTH * 0.5 maskAlpha:0.05 scaleY:1.0 direction:CWDrawerTransitionFromLeft backImage:nil];
}
