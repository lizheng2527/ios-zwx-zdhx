...
@implementation PAddServerRecordCell
...
-(void)initCellView
{
    ...
    _textView_SelfGrade.layer.masksToBounds = YES;
    _textView_SelfGrade.layer.cornerRadius = 3.0f;
    _textView_SelfGrade.layer.borderWidth = 0.5f;
    _textView_SelfGrade.layer.borderColor = [UIColor lightGrayColor].CGColor;
}
