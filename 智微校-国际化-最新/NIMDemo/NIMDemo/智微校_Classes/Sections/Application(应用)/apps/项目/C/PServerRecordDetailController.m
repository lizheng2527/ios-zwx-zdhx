//
//  PServerRecordDetailController.m
//  NIM
//
...
#import "PServerRecordDetailCell.h"
...
@interface PServerRecordDetailController ()<UITableViewDelegate,UITableViewDataSource,UIDocumentInteractionControllerDelegate>

@property(nonatomic,retain)NSMutableArray *photos;

@end

@implementation PServerRecordDetailController
{
...
-(void)requestData
{
    ...
    [helper getServiceRecordIdDetailWithVisitRecordId:_projectID andStatus:^(BOOL successful, NSDictionary *jsonDic) {
        mainDic = jsonDic;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row == 0) {
        ...
        cell.schoolLinkerTextfield.text = [mainDic objectForKey:@"linkMan"];
        cell.schoolLinkerPhoneTextfield.text = [mainDic objectForKey:@"linkManPhone"];
        cell.serviceAddPersonTextfield.text = [mainDic objectForKey:@"together"];
        
        cell.textView_Jianshu.text = [mainDic objectForKey:@"sketch"];
        cell.textView_Target.text = [mainDic objectForKey:@"serviceTarget"];
        cell.textView_Member.text = [mainDic objectForKey:@"serviceContent"];
        cell.textView_SelfGrade.text = [mainDic objectForKey:@"selfEvaluation"];
