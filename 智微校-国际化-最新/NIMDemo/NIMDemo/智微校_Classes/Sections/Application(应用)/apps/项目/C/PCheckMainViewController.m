...
- (NSMutableArray *)dataArray {
    ...
    if (_dataArray == nil) {
        ...
        NSArray * array = [NSArray arrayWithObjects:@{@"title":NSLocalizedString(@"APP_assets_All", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_assets_notReview", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_assets_hasPass", nil),@"status":@"0"}, nil];
...
-(void)addItemAction:(id)sender
{
    ...
    UIAlertAction* cancelAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"APP_General_Cancel", nil) style:UIAlertActionStyleCancel
