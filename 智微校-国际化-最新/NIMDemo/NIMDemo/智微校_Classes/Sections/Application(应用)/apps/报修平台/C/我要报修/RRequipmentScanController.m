...
- (void)SGQRCodeInformationFromeAibum:(NSNotification *)noti {
    ...
    UIAlertController *alertC = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"APP_General_Prompt", nil) message:string preferredStyle:(UIAlertControllerStyleAlert)];
