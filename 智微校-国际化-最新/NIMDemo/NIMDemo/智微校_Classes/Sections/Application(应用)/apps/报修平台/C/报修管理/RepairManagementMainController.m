...
- (NSMutableArray *)dataArray {
    ...
    if (_dataArray == nil) {
        ...
        NSArray * array = [NSArray arrayWithObjects:@{@"title":NSLocalizedString(@"APP_assets_All", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_repair_Deal", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_repair_hasSendDan", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_MyHomeWork_hasFinished", nil),@"status":@"0"}, @{@"title":NSLocalizedString(@"APP_repair_moneyCheck", nil),@"status":@"0"},nil];
...
-(void)initView
{
    self.title = NSLocalizedString(@"APP_repair_repairManagement", nil);
