...
- (NSMutableArray *)dataArray {
    ...
    if (_dataArray == nil) {
        ...
        NSArray * array = [NSArray arrayWithObjects:@{@"title":NSLocalizedString(@"APP_repair_repairSubmitDetail", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_repair_repairStepRecord", nil),@"status":@"0"},nil];
