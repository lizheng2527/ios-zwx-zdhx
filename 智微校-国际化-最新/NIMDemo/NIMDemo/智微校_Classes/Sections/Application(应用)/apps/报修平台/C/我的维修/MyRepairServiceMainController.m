...
- (NSMutableArray *)dataArray {
    ...
    if (_dataArray == nil) {
        ...
        NSArray * array = [NSArray arrayWithObjects:@{@"title":NSLocalizedString(@"APP_assets_All", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_repair_repairing", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_repair_hasFeedback", nil),@"status":@"0"},nil];
...
-(void)initView
{
    self.title = NSLocalizedString(@"APP_repair_myMaintenance", nil);
