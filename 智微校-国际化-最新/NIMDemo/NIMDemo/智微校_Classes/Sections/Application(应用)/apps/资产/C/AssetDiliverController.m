...
- (NSMutableArray *)dataArray {
    ...
    if (_dataArray == nil) {
        ...
        NSArray * array = [NSArray arrayWithObjects:@{@"title":NSLocalizedString(@"APP_assets_All", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_assets_waitReview", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_assets_hasPass", nil),@"status":@"0"},@{@"title":NSLocalizedString(@"APP_assets_notPass", nil),@"status":@"0"}, nil];
