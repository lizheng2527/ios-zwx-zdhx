...
#define             STROKE_WIDTH_MAX 0.0150
...
//        _clearBtn.frame = CGRectMake([UIScreen mainScreen].bounds.size.width / 2, [UIScreen mainScreen].bounds.size.height / 2, 30, 30);
...
//            _clearBtn.frame = CGRectMake([UIScreen mainScreen].bounds.size.width / 2, [UIScreen mainScreen].bounds.size.height / 2, 30, 30);
        ...
        _clearBtn.frame = CGRectMake([UIScreen mainScreen].bounds.size.width / 2 - 40,[UIScreen mainScreen].bounds.size.height / 2 - 15,30, 30);
//        _clearBtn.center = self.center;
//            [self addSubview:_clearBtn];
        [_clearBtn setBackgroundColor:[UIColor lightGrayColor]];
            [_clearBtn setTitle:@"Ccc" forState:UIControlStateNormal];
        [_clearBtn addTarget:self action:@selector(erase) forControlEvents:UIControlEventTouchUpInside];
