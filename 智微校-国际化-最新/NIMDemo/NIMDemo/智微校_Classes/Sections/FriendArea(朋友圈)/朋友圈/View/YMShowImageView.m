...
//        photo.url = [NSURL URLWithString:[NSString stringWithFormat:@"%@",[appendArray objectAtIndex:i]]];
//
//        //设置来源哪一个UIImageView
...
//        imageView.image = img;
        [imageView sd_setImageWithURL:[NSURL URLWithString:[appendArray objectAtIndex:i]] placeholderImage:[UIImage imageNamed:@"hhh"]];
