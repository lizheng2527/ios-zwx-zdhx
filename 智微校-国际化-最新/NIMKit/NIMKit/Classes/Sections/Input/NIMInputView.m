...
- (void)setup
{
    if (!_toolBar)
    {
        ...
        [_toolBar.recordButton setTitle:NSLocalizedString(@"APP_YUNXIN_Conversation_pressToTalk", nil) forState:UIControlStateNormal];
                ...
                if (granted) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        [[[UIAlertView alloc] initWithTitle:nil
                                                    message:NSLocalizedString(@"APP_YUNXIN_Conversation_noLimitationOfMicrophone", nil)
                                                   delegate:nil
                                          cancelButtonTitle:NSLocalizedString(@"APP_General_Confirm", nil)
