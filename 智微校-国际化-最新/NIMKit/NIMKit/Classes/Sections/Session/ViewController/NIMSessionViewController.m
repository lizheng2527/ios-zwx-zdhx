...
- (NSArray *)menusItems:(NIMMessage *)message
{
    ...
    if (copyText) {
        [items addObject:[[UIMenuItem alloc] initWithTitle:NSLocalizedString(@"APP_General_copppy", nil)
                                                    action:@selector(copyText:)]];
    }
    [items addObject:[[UIMenuItem alloc] initWithTitle:NSLocalizedString(@"APP_note_Delete", nil)
