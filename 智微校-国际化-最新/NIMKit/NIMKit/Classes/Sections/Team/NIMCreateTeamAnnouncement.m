...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = NSLocalizedString(@"APP_YUNXIN_createGroupNote", nil);
    ...
    self.titleTextField.placeholder = NSLocalizedString(@"APP_wareHouse_pickerTitle", nil);
